...
enum SpellCastFlags
{
    CAST_FLAG_NONE               = 0x00000000, /**enum val 1*/
    CAST_FLAG_PENDING_SPELL_CAST = 0x00000001, /** may be pending spell cast*/
    ...
    CAST_FLAG_UNKNOWN_19         = 0x00040000,                // spell cooldown related (may be category cooldown)
    CAST_FLAG_VISUAL_CHAIN       = 0x00080000,                // wotlk
    CAST_FLAG_UNKNOWN_21         = 0x00100000,
    CAST_FLAG_RUNES_STATES       = 0x00200000,                // wotlk, rune cooldown list
...
class Spell
{
    ...
    public:
        ...
        /*Iz Classe Spell Cast Raget dobijemo target*/
