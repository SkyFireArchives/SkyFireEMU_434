...
#define DEFINE_OPCODE_HANDLER(opcode, status, processing, handler)                              \
    ...
    memset(opcodeTable, 0, sizeof(opcodeTable));
	 ...
	 DEFINE_OPCODE_HANDLER(CMSG_MOVE_UPDATE_MOUSE,                       STATUS_LOGGEDIN, PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
	 ...
	 DEFINE_OPCODE_HANDLER(CMSG_MOVE_REQUEST_STATUS,					 STATUS_LOGGEDIN, PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
     ...
     //DEFINE_OPCODE_HANDLER(CCMSG_MOVE_STOP_SWIM_CHEAT,                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
