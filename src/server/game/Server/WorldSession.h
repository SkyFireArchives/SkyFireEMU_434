...
public:
    ...
    static uint32 DropHighBytes(uint32 opcode) { return uint32(opcode & 0xFFFF); }
...
class WorldSession
{
    public:
        ...
        void SendInviteResult(Player* inviter, Player* invitee, bool success);
    ...
    public:                                                 // opcodes handlers
        ...
        void HandleCharSetPosition(WorldPacket& recvPacket);
        ...
        void HandleGroupInviteResponse(WorldPacket& recvPacket);
