...
namespace Movement
{
    ...
    public:
         ...
         */
        void SetFixedOrientation(bool enable);
    ...
    inline void MoveSplineInit::SetFixedOrientation(bool enable) { args.flags.fixedorientation = enable;}
    ...
    inline void MoveSplineInit::SetParabolic(float amplitude, float time_shift)
    {
        ...
        args.fixedorientation_amplitude = amplitude;
...
#endif // SKYFIRESERVER_MOVESPLINEINIT_H
