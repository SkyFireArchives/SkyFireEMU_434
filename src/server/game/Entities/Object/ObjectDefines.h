...
enum HighGuid
{
    ...
    HIGHGUID_PLAYER         = 0x000,                       // blizz 000
    HIGHGUID_GAMEOBJECT     = 0xF11,                       // blizz F11
    HIGHGUID_TRANSPORT      = 0xF12,                       // blizz F12 (for GAMEOBJECT_TYPE_TRANSPORT)
    HIGHGUID_UNIT           = 0xF13,                       // blizz F13
    HIGHGUID_PET            = 0xF14,                       // blizz F14
    HIGHGUID_VEHICLE        = 0xF15,                       // blizz F15
    HIGHGUID_DYNAMICOBJECT  = 0xF10,                       // blizz F10
    HIGHGUID_CORPSE         = 0xF50,                       // blizz F50
    HIGHGUID_MO_TRANSPORT   = 0x1FC,                       // blizz 1FC (for GAMEOBJECT_TYPE_MO_TRANSPORT)
    HIGHGUID_GROUP          = 0x1F5,
    HIGHGUID_GUILD          = 0x1F6                         // new 4.x
};
...
#define MAKE_NEW_GUID(l, e, h)   uint64(uint64(l) | (uint64(e) << 32) | (uint64(h) << 48))
